...
import Textbox from "@/components/father2/Textbox";
import walkingSprite from "@themes/father2/andy/side-walking.gif";
import idleSprite from "@themes/father2/andy/walking.gif";
import poseSprite from "@themes/father2/andy/pose.png";
...
export default function Father2Page() {
  ...
  return (
    <main
      className="father2-theme min-h-screen text-zinc-900"
      style={{
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-4xl flex-col items-center py-12">
        ...
        >
          <div className="relative flex h-full flex-col justify-between">
            <div className="grid grid-cols-[1fr_auto] gap-x-8 gap-y-8">
              <div className="justify-self-start">
                ...
                <div className="flex flex-row items-center">
                  <Image
                    src="/themes/father2/andy/status.png"
                    ...
                    <div className="flex h-full flex-col justify-between text-6xl">
                      <div className="space-y-2">
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <button
                            type="button"
                            className="cursor-[url('/themes/father2/textbox/select.gif'),pointer]"
                          ...
                          >
                            <span className="inline-flex items-center gap-2">
                              {hoveredPsiMove === "PSI Gaming" ? (
                                <Image
                                  src="/themes/father2/textbox/select.gif"
                                  alt=""
                                  width={24}
                                  height={24}
            ...
            <p className="text-center">
              ...
              <button
                type="button"
                className="cursor-[url('/themes/father2/textbox/select.gif'),pointer] underline underline-offset-4"
                onClick={() => {
                  setHoveredPsiMove(null);
        ...
        <div className="flex w-full flex-col mt-[16] justify-center items-center gap-6">
          <div className="relative gap-12 flex flex-row">
            <Image
              src={"/themes/father2/andy/sleeping.gif"}
            ...
            />
            <Image
              src="/themes/father2/spacebup/space_buddy.gif"
          ...
          <div className="flex gap-8">
            ...
            <Image
              src={"/themes/father2/andy/jamming.gif"}
